...
public class AntTester {
    public static void main(String args[]) {
        ...
        boolean visited[] = { true, true, false, true, false, false, false, true, false, false, true, true, true, true,
                false, false, true, false, false, true };
        DecimalFormat df = new DecimalFormat("0.00");

        /*
         * show FULL list of edges in console - commented out, might be useful when
         * debugging
         * System.out.println("FULL list of edges:\nEdge\t\tlength\t\tpheromone"); for
         * (int i = 0; i < numNodes - 1; i++) { for (int j = i + 1; j < numNodes; j++) {
         * System.out.println("("+i+","+j+")\t\t"+edgeLengths[i][j]+"\t\t"+sim.
         * getPheromoneLevel(i,j)); } }
         */

        /*
         * test Ant.java methods (1) to (5) these methods 'chain': the output from one
         * method is used by the next but this testing code uses the known correct
         * answers as input parameters, to allow each method's correctness to be tested
         * independently
         */
        ...
        ArrayList<Double> correctProbs = initDoubleArray(
                new double[] { 0.08, 0.07, 0.21, 0.17, 0.06, 0.05, 0.04, 0.13, 0.10, 0.09 });
        ArrayList<Double> correctCumulative = initDoubleArray(
                new double[] { 0.08, 0.15, 0.36, 0.53, 0.59, 0.64, 0.68, 0.81, 0.91, 1.00 });
        ...
        int[] expected = new int[] { 0, 0, 800, 0, 700, 2100, 1700, 0, 600, 500, 0, 0, 0, 0, 400, 1300, 0, 900, 900,
                0 };
        ...
        System.out.println(
                "'expected' is what the values should roughly be, 'actual' is the values given by your code\n");
